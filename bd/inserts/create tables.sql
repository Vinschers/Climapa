...
CREATE TABLE Regiao (
	...
	ID_TIPO_REGIAO_PAI int NOT NULL,
	ARTIGO varchar(1) NOT NULL,
	CONSTRAINT PK_Regiao PRIMARY KEY (ID),
	CONSTRAINT FK_TipoRegiaoRegiao01 FOREIGN KEY (ID_TIPO_REGIAO)
	REFERENCES Regiao(ID),
	CONSTRAINT FK_TipoRegiaoRegiao02 FOREIGN KEY (ID_TIPO_REGIAO_PAI)
	REFERENCES Regiao(ID)
);
