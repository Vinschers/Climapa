...
for n in range(10000):
    ...
    print(f"INSERT INTO Populacao(id_regiao, mes, ano, qtd_pessoas, qtd_nascimentos, qtd_mortes) VALUES('{id_regiao}','{mes}','{ano}', '{qtd_pessoas}','{qtd_nascimentos}','{qtd_mortes}');")
